...
import Plantilla1Dom2 from './plantillas/plantilla1-dom2'; // Importa la primera plantilla
import Plantilla2Dom2 from './plantillas/plantilla2-dom2'; // Importa la segunda plantilla
...
const TareasDom2 = () => {
  ...
  const obtenerPlantillaAleatoria = () => {
    const plantillas = [Plantilla1Dom2, Plantilla2Dom2];
  ...
  return (
    <div className="bg-purple-200 text-blue-900 min-h-screen flex flex-col justify-center items-center">
      <div className="p-4 rounded-lg shadow-md text-center">
        <h2 className="flex items-center">
          ...
          <span className="text-xl font-semibold">
            Tema: Ondas estacionarias y viajeras
          </span>
        </h2>
      ...
      {mostrarAlternativas && <Alternativas datos={{ dominio: 2, avance: usuarioDeURL.avance, numeroPreguntas: limitePreguntas }} />}
      ...
      {mostrarPlantillaAleatoria ? (
        ...
        generarValorAleatorio < 0.5 ? <Plantilla1Dom2 /> : <Plantilla2Dom2 />
      ) : null}
