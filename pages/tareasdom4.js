...
const TareasDom4 = () => {
  ...
  const obtenerPlantillaAleatoria = () => {
    const plantillas = [Plantilla1Dom4, Plantilla2Dom4];
  ...
  return (
    <div className="bg-purple-200 text-blue-900 min-h-screen flex flex-col justify-center items-center">
      ...
      {mostrarAlternativas && <Alternativas datos={{ dominio: 4, avance: usuarioDeURL.avance, numeroPreguntas: limitePreguntas }} />}
      ...
      {mostrarPlantillaAleatoria ? (
        ...
        generarValorAleatorio < 0.5 ? <Plantilla1Dom4 /> : <Plantilla2Dom4 />
      ) : null}
